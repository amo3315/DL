...
AlexNet = Sequential()
AlexNet.add(Conv2D(96,(11,1),strides = (4,1),padding='valid',input_shape=(8196,1,1),activatioon = 'relu',kernel_initializer='uniform'))
AlexNet.add(MaxPool2D((3,1),strides=(2,1)))
AlexNet.add(Conv2D(256,(5,1),strides=1,padding='same',activatioon = 'relu',kernel_initializer='uniform'))
AlexNet.add(MaxPool2D((3,1),strides=(2,1)))
AlexNet.add(Conv2D(384,(3,1),strides=1,padding='same',activatioon = 'relu',kernel_initializer='uniform'))
AlexNet.add(Conv2D(384,(3,1),strides=1,padding='same',activatioon = 'relu',kernel_initializer='uniform'))
AlexNet.add(Conv2D(256,(3,1),strides=1,padding='same',activatioon = 'relu',kernel_initializer='uniform'))
AlexNet.add(Flatten())
...
AlexNet.compile(optimizer=keras.optimizers.Adam(lr=0.005),loss='categorical_crossentropy',metrics=['accuracy'])

batch_size = 1440
epochs = 10
history = AlexNet.fit(X_train,y_train,batch_size=batch_size,epochs=epochs,validation_data=[X_test,y_test])
